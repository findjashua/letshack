...
baseUrl = if development then 'http://127.0.0.1:3000' else 'http://hackr-trackr.herokuapp.com'
...
EVENTBRITE_CLIENT_SECRET = if development then 'YZQ7EF655XJBMP2F4D2Q4SFUNAY3MDZCDBW5U2SYAW46I5BFSZ' else 'KCI5LM3WL3HJNDOD4EA4E3NHJ4P5BQYFMQDUUG46PSGC2YF7QU'
